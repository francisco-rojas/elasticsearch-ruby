  ...
  module Transport
    module Transport
      module HTTP
        ...
        #
        #     client = LegacyElasticsearch::Client.new transport_class: LegacyElasticsearch::Transport::Transport::HTTP::Manticore
        #
        ...
        #       transport_class: LegacyElasticsearch::Transport::Transport::HTTP::Manticore,
        #       ssl: {
