...
class LegacyElasticsearch::Transport::Transport::Connections::SelectorTest < Test::Unit::TestCase
  include LegacyElasticsearch::Transport::Transport::Connections::Selector
