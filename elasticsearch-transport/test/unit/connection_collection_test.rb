...
class LegacyElasticsearch::Transport::Transport::Connections::CollectionTest < Test::Unit::TestCase
  include LegacyElasticsearch::Transport::Transport::Connections
