...
class LegacyElasticsearch::Transport::ClientIntegrationTest < LegacyElasticsearch::Test::IntegrationTestCase
  startup do
  ...
  context "Elasticsearch client" do
    ...
    context "when reloading connections" do
      should "keep existing connections" do
        ...
        client = LegacyElasticsearch::Transport::Client.new host: "localhost:#{@port}", adapter: :patron, logger: @logger
    ...
    context "with Faraday adapters" do
      should "set the adapter with a block" do
        ...
        client = LegacyElasticsearch::Transport::Client.new url: "localhost:#{@port}" do |f|
      ...
      should "automatically use the Patron client when loaded" do
        ...
        require 'patron'
        client = LegacyElasticsearch::Transport::Client.new host: "localhost:#{@port}"
