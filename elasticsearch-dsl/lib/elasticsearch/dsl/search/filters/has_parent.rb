      ...
      module Filters
        ...
        class HasParent
          ...
          def query(*args, &block)
            @query = block ? @query = LegacyElasticsearch::DSL::Search::Query.new(*args, &block) : args.first
            self
          end
          ...
          def filter(*args, &block)
            @filter = block ? LegacyElasticsearch::DSL::Search::Filter.new(*args, &block) : args.first
            self
          end
