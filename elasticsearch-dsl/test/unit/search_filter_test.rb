...
module LegacyElasticsearch
  module Test
    class SearchFilterTest < ::Test::Unit::TestCase
      subject { LegacyElasticsearch::DSL::Search::Filter.new }
      ...
      context "Search Filter" do
        ...
        should "evaluate the block and return itself" do
          block   = Proc.new { 1+1 }
          subject = LegacyElasticsearch::DSL::Search::Filter.new &block

          subject.expects(:instance_eval)
          assert_instance_of LegacyElasticsearch::DSL::Search::Filter, subject.call
        end
